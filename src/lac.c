 ...
 * ----------------------------------------------------------------------- *
 *  Ten plik zawiera wylacznie main( ), zeby mozna bylo kompilowac Laca    *
 *  i Glace bez przekompilowywania comm.o.                                 *
 *  Przy okazji, wyjsciowy plik lac.o swietnie pomaga wykryc blednie       *
 *  zadeklarowane w merc.h rzeczy - nm lac.o pokaze zmienne globalne,      *
 *  jesli sie tam przypadkiem znajda bez "extern" :)                       *
 * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * */
...
{
    return comm_main( FALSE, argc, argv );
}
